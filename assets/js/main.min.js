...
$(function () {
  ...
  if ($('.p-history').length) {
    var taboffset = $('.p-history_header').offset().top; // 取得最新的年份

    var activeYear = $('.p-history_item:eq(0)').data('year');
    $(window).on('scroll', function () {
      var scrollPos = $(window).scrollTop(); // 滑動到沿革大事記時固定在上方，並且出現年份
